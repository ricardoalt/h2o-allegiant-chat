...
export type PromptInputAttachmentPreviewProps = ComponentProps<typeof AttachmentItemPreview>;

export const PromptInputAttachmentPreview = (
  props: PromptInputAttachmentPreviewProps,
): JSX.Element => <AttachmentItemPreview {...props} />;

export type PromptInputAttachmentRemoveProps = ComponentProps<typeof AttachmentItemRemove>;
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = useCallback(
    async (event) => {
      ...
      try {
        ...
        onError?.({
          code: "read_failed",
          message: "We couldn't read one or more files. Remove them and try again.",
        });
        // Don't clear on error - user may want to retry
      }
    },
